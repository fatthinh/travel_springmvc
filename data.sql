...
CREATE TABLE `activity` (
  ...
  `transport` enum('PLANE','LIMOUSINE','FERRY') COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `bill_transaction` (
  `id` int NOT NULL,
  `method` enum('BANKING','CASH') COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `blog` (
  ...
  `description` text COLLATE utf8mb4_unicode_520_ci,
  `quote` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `booking` (
  `status` enum('PAID','DEPOSIT') COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
INSERT INTO `category` VALUES (1,'Art & Culture'),(2,'Food & Drink'),(3,'Outdoor Activities'),(4,'Tours, Sightseeing & Cruises');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `image` (
  `src` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  PRIMARY KEY (`id`)
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `review` (
  `rating` enum('BANKING','CASH') COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `role` enum('ADMIN','CUSTOMER','CASHIER','RECEPTIONIST','TOUR_GUIDE') COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `id` int NOT NULL AUTO_INCREMENT,
  `first_name` varchar(50) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `last_name` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  `dob` date DEFAULT NULL,
...
-- Dump completed on 2024-06-24 14:51:07
