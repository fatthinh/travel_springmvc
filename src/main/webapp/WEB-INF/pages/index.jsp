...
<div class="products-area-wrapper tableView">
    <div class="products-header">
        ...
        <div class="product-cell">Departure</div>
        <div class="product-cell">Duration</div>
    ...
    <div class="products-row">
        ...
        <div class="product-cell">
            <span class="cell-label">Name:</span>Furniture
        </div>
        <div class="product-cell">
            <span class="cell-label">Departure:</span>HO CHI MINH CTY
        </div>
        <div class="product-cell">
            <span class="cell-label">Duration</span>36 hours
        </div>
        <div class="product-cell">
    ...
    <div class="products-row">
        ...
        <div class="product-cell">
            <span class="cell-label">Name:</span>Kitchen
        </div>
        <div class="product-cell">
            <span class="cell-label">Departure:</span>HO CHI MINH CTY
        </div>
        <div class="product-cell">
            <span class="cell-label">Duration</span>46 hours
        </div>
        <div class="product-cell">
    ...
    <div class="products-row">
        ...
        <div class="product-cell">
            <span class="cell-label">Name:</span>Decoration
        </div>
        <div class="product-cell">
            <span class="cell-label">Departure:</span>HO CHI MINH CTY
        </div>
        <div class="product-cell">
            <span class="cell-label">Duration</span>56 hours
        </div>
        <div class="product-cell">
    ...
    <div class="products-row">
        ...
        <div class="product-cell">
            <span class="cell-label">Name:</span>Bedroom
        </div>
        <div class="product-cell">
            <span class="cell-label">Departure:</span>HO CHI MINH CTY
        </div>
        <div class="product-cell">
            <span class="cell-label">Duration</span>66 hours
        </div>
        <div class="product-cell">
    ...
    <div class="products-row">
        ...
        <div class="product-cell">
            <span class="cell-label">Duration</span>40 hours
        </div>
        <div class="product-cell">
    ...
    <div class="products-row">
        ...
        <div class="product-cell">
            <span class="cell-label">Name:</span>Bathroom
        </div>
        <div class="product-cell">
            <span class="cell-label">Departure:</span>HO CHI MINH CTY
        </div>
        <div class="product-cell">
            <span class="cell-label">Duration</span>44 hours
        </div>
        <div class="product-cell">
    ...
    <div class="products-row">
        ...
        <div class="product-cell">
            <span class="cell-label">Duration</span>45 hours
        </div>
        <div class="product-cell">
    ...
    <div class="products-row">
        ...
        <div class="product-cell">
            <span class="cell-label">Name:</span>Living Room
        </div>
        <div class="product-cell">
            <span class="cell-label">Departure:</span>HO CHI MINH CTY
        </div>
        <div class="product-cell">
            <span class="cell-label">Duration</span>16 hours
        </div>
        <div class="product-cell">
