...
<div id="activity-gallery" class="modal hide" style="display: block" data-id="${tourdetails.getId()}">
        ...
        <div class="products-area-wrapper gridView gallery">
            <c:forEach items="${activities}" var="item">
                <div class="products-row" >
                    ...
                    <c:forEach var="tourplanItem" items="${tourplan}">
                        <c:if test="${tourplanItem.getActivityId().getId() eq item.getId()}">
