...
//                    !e.target.classList.contains("js-remove-passenger")
//                    ) {
//                const isHidden = $(target).classList.contains("hide");
//                if (!isHidden) {
//                    button.click();
...
//    const passengers = $(".passenger-list");
...
//            <button class="btn btn--small btn--danger js-remove-passenger">
//              <i class="bx bx-x"></i>
//            </button>
//          </div>
//        </div>
...
//    if (event.target && event.target.classList.contains("js-remove-passenger")) {
//        var passengerItem = event.target.closest(".passenger-item");
//        if (passengerItem) {
